...
public class AqiService {
    ...
    public Map<String, Object> getAqiByCity(String city) {
        try {
            ...
            // Step 1: Search locations by city name, pick one with recent data
            String locationUrl = "https://api.openaq.org/v3/locations?city="
                    + city + "&limit=10";
            ...
            // Pick the station with the most sensors
            ...
            String stationName = city; // use searched city name, not station code

            // Step 2: Get latest sensor readings using sensors list
            ...
            for (JsonNode sensor : sensors) {
                ...
                // Fetch latest value for this sensor
                ...
                try {
                    ...
                    if (!sensorResults.isEmpty()) {
                        ...
                        if (value >= 0) {
                            pollutants.put(paramName, value);
                        }
                    }
    ...
    private double calcPm25(double cp) {
        ...
        return linearInterpolate(cp, table);
    }
